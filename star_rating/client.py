...
class StarRatingClient:
    ...
    def parse_statistics(self, result: Dict) -> Dict:
        ...
        for data_item in data_list:
            unique_marker = data_item.get("uniqueMarker", "")

            # 根据uniqueMarker解析不同组件的数据
            if unique_marker == "starRealtimeSummary":
                ...
                for item in body:
                    ...
                    if name == "点评星级":
                        statistics["点评星级"] = value
                    elif name == "美团星级":
                        statistics["美团星级"] = value
